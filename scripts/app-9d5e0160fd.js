...
(function() {
  ...
  angular
    .module('weatherApp')
    .directive('waCarousel', carouselDirective);
...
(function() {
  ...
  function MainController($scope) {
    ...
    vm.imgs = [
      { src: 'https://lh4.googleusercontent.com/-z0Fy11zHKCo/VNBUeKuy0hI/AAAAAAAAABU/Y37bW1M4G8IrnIhAlBmxsdKVfhklwGx-w/s1600-w400/', name: 'morgan',      width: 100, height: 200 },
      { src: 'https://lh5.googleusercontent.com/-IDEZHXmzqao/VNEMX08fv_I/AAAAAAAAAAc/k4BwdtIrjlcn1UlJ3pxr5HcLcc6PlqyyA/s1600-w400/', name: 'nails',       width: 100, height: 200 },
      { src: 'https://lh6.googleusercontent.com/-qvD2BiDxKG8/VFjhIVvNxbI/AAAAAAAAAHA/A6RzgujPT1060orriCC3sfy6PffPnujSw/s1600-w298/', name: 'pregnancy',   width: 100, height: 200 },
    ];
...
$templateCache.put("app/main/main.html","<div class=container><acme-navbar geo=main.geo></acme-navbar><ui-view></ui-view><input type=text class=geo ng-model=main.geo.address googleplace get-coordinates=main.geo><div ng-if=main.geo.latitude>lat: {{main.geo.latitude}} lon: {{main.geo.longitude}}</div><wa-carousel images=main.imgs></wa-carousel></div>");
$templateCache.put("app/components/carousel/carousel.html","<div class=carousel><div class=images><img ng-src={{images[current].src}} width=600 height=400><!-- <ul class=\"img-holder\"> --><!-- <li ng-repeat=\"image in images track by $index\">\n        <img  ng-src=\"{{image.src}}\" alt=\"img_{{$index}}\" width=\"600\" height=\"400\">\n      </li> --><!-- </ul> --><div class=controls><div class=prev ng-if=\"current - 1 >= 0\" ng-click=prev()>&nbsp;</div><div class=next ng-if=\"current + 1 < images.length\" ng-click=next()>&nbsp;</div></div></div></div>");
...
//# sourceMappingURL=../maps/scripts/app-9d5e0160fd.js.map
